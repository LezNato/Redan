...
<p align="center">
  <img src="https://img.shields.io/badge/version-v0.12.0-blue.svg" alt="Version: v0.12.0">
...
[Claude Code](https://docs.claude.com/en/docs/claude-code/overview); the 78
...
- **Python 3.10+** — the 78 tools are stdlib Python.
...
- **78 stdlib modules** (`tools/checks/`, stdlib-only, JSON) — recon + business-process modeling, active testing (injection, XSS incl. client-side DOM, SSRF, access control + 401/403 bypass, request smuggling, file upload, SOAP/XXE, rate limiting, JWT, AI/LLM surface, …), visual triage, authenticated testing, edge-egress rotation, and reporting. Full catalog: [`tools/checks/README.md`](tools/checks/README.md).
...
tools/checks/                                     78 stdlib modules (stdlib-only, JSON)
